    ...
    <table class="table">
        ...
        <tbody>
            <tr v-for="(use, index) in uses">
                ...
                <td>
                    <button class="btn btn-primary" @click="setEditUse(use)" data-bs-toggle="modal" data-bs-target="#EditUseModal">
                        Edit
                    </button>
    ...
    <div class="modal fade" id="EditUseModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" @click="editUse" data-bs-dismiss="modal">Save changes</button>
            </div>
            </div>
        </div>
    </div>
