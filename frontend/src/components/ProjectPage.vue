...
<template>
    <ProjectTable :projects="projects" @edit-project="editProject" @delete-project="deleteProject" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <textarea v-model="newProject.description" class="form-control" id="description"
                            rows="3"></textarea>
                    </div>
                    <div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" @click="createProject" data-bs-dismiss="modal">Save
                        changes</button>
                </div>
            </div>
        </div>
