   ...
   <table class="table">
      ...
      <tbody>
         <tr v-for="(project, index) in projects">
            ...
            <td>
               <button class="btn btn-primary" @click="setEditProject(project)" data-bs-toggle="modal"
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               <button type="button" class="btn btn-primary" @click="editProject" data-bs-dismiss="modal">Save
                  changes</button>
            </div>
         </div>
      </div>
